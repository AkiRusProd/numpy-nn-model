...
class _MaxPool2dTensor(Tensor):
    ...
    def backward(self, grad):
        ...
        grad_col[self.xp.arange(grad_col.shape[0]), np.nanargmax(windows, axis=1)] = grad.reshape(-1)
...
class MaxPool2d:
        ...
        def forward(self, X: Tensor):
            ...
            self.dilated_kernel_size, self.kernel, windows, O_einsum], "maxpool2d", device = X.device)
