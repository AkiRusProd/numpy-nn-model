...
from neunet.nn.experimental.utils import load_dlls, get_module_path, CUDA_CUTLASS_LINEAR_MODULE

load_dlls()
CUDA_LINEAR_DLL_PATH = get_module_path(CUDA_CUTLASS_LINEAR_MODULE)
...
class _CUDACUTLASSLinearTensor(Tensor):
...
class CUDACUTLASSLinear(Module):
    ...
    def forward(self, X: Tensor) -> Tensor:
        ...
        return _CUDACUTLASSLinearTensor(
