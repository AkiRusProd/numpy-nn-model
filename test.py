...
model.add(Conv2D(kernels_num = 8, kernel_shape = (5, 5), activation = "relu", use_bias = False))
model.add(MaxPooling2D())
model.add(Conv2D(kernels_num = 32, kernel_shape = (3, 3), padding = "same", activation = LeakyReLU(), use_bias = False))
